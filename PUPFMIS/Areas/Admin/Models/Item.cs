...
namespace PUPFMIS.Models
{
    ...
    [Table("PP_MASTER_INVENTORY_TYPES")]
    ...
    [Table("PP_MASTER_ITEM_CATEGORIES")]
    ...
    [Table("PP_MASTER_ITEM_ALLOWED_USERS")]
    ...
    public class ItemTypeVM
    {
        ...
        [Display(Name = "Inventory Type")]
        public string InventoryTypeReference { get; set; }
