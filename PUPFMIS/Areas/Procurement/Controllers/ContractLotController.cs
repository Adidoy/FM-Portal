...
namespace PUPFMIS.Areas.Procurement.Controllers
{
    ...
    [RoutePrefix("projects/contracts/lot")]
    [Authorize(Roles = SystemRoles.ProjectCoordinator)]
    public class ContractLotController : Controller
    {
        ContractLotDAL contractDAL = new ContractLotDAL();
        ContractLotBL contractBL = new ContractLotBL();
        ...
        public ActionResult Details(string ContractCode)
        {
            ...
            //{
            //    return NoticeOfAwardSetup(ContractCode);
            //}
        ...
        //public ActionResult OpenContract(string ContractCode)
        //{
        ...
        public ActionResult NoticeOfAwardSetup(string ContractCode)
        {
        ...
        {
            //var contract = contractDAL.GetSingleContractDetails(ContractCode);
            return View("ProjectConclusion");
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        [ActionName("PRSubmissionClosed")]
        public ActionResult PreProcurementConferenceSetup(PreProcurementConferenceLotSetupVM Contract)
        {
            if (ModelState.IsValid)
            {
                return Json(new { result = contractDAL.PostPreProcurementConferenceSetup(Contract, User.Identity.Name), JsonRequestBehavior.AllowGet });
            }
            return View(Contract.ProcurementProjectStage.ToString(), Contract);
        }
        ...
        public ActionResult PreProcurementConferenceUpdate(PreProcurementConferenceLotUpdateVM Contract)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult PreBidConferenceSetup(PreBidConferenceLotSetupVM Contract)
        {
