...
namespace PUPFMIS.Models
{
    ...
    public class OpenLotProcurementProjectDetailsVM
    {
        [Required]
    ...
    public class OpenLotProcurementProjectVM
    {
        ...
        public List<OpenLotProcurementProjectDetailsVM> OpenLotDetails { get; set; }

        public List<LotDetailsVM> Details { get; set; }

        public List<ContractUpdates> Updates { get; set; }
    }

    public class PreProcurementConferenceLotSetupDetailsVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class PreProcurementConferenceLotSetupVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
        ...
        public List<PreProcurementConferenceLotSetupDetailsVM> Details { get; set; }
        public List<ContractUpdates> Updates { get; set; }
    }

    public class PreProcurementConferenceLotUpdateDetailsVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class PreProcurementConferenceLotUpdateVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
        ...
        public List<PreProcurementConferenceLotUpdateDetailsVM> Details { get; set; }
        public List<ContractUpdates> Updates { get; set; }
    }

    public class PreBidConferenceLotSetupDetailsVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class PreBidConferenceLotSetupVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
        ...
        public List<PreBidConferenceLotSetupDetailsVM> Details { get; set; }
        public List<ContractUpdates> Updates { get; set; }
    }

    public class PreBidConferenceLotUpdateDetailsVM
    {
        [Display(Name = "Contract Code")]
        public string ContractCode { get; set; }
    ...
    public class PreBidConferenceLotUpdateVM
    {
        [Display(Name = "Parent Contract")]
        public string ParentProjectReference { get; set; }
        ...
        public List<PreBidConferenceLotUpdateDetailsVM> Details { get; set; }
        public List<ContractUpdates> Updates { get; set; }
    }


    public class OpeningOfBidsLotUpdateVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class EvaluationOfBidsLotUpdateVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class PostQualificationLotUpdateVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class NoticeOfAwardLotSetupVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class NoticeOfAwardLotUpdateVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class NoticeToProceedLotSetupVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class NoticeToProceedLotUpdateVM
    {
        [Display(Name = "Lot/Line No.")]
        public int? LotNo { get; set; }
    ...
    public class PreProcurementConferenceLotTemplateDetailsVM
    {
        public string ContractCode { get; set; }
        public string ContractName { get; set; }
    ...
    public class PreProcurementConferenceLotTemplateVM
    {
        public string ContractCode { get; set; }
        public string ContractName { get; set; }
        public string ProjectCoordinator { get; set; }
        ...
        public List<PreProcurementConferenceLotTemplateDetailsVM> LotDetails { get; set; }
    }
    public class InvitationToBidLotTemplateDetailsVM
    {
    ...
    public class InvitationToBidLotTemplateVM
    {
        [Display(Name = "Date")]
        ...
        public List<InvitationToBidLotTemplateDetailsVM> Details { get; set; }
    }
    public class RequestForQuotationLotTemplateVM
    {
        [Display(Name = "Fiscal Year")]
        public int FiscalYear { get; set; }
    ...
    public class NoticeOfAwardLotTemplateVM
    {
        [Display(Name = "Contractor/Supplier")]
    ...
    public class NoticeToProceedLotTemplateVM
    {
        [Display(Name = "Contractor/Supplier")]
        public string Supplier { get; set; }
    ...
    public class PurchaseOrderLotTemplateVM
    {
        [Display(Name = "Fiscal Year")]
        public int FiscalYear { get; set; }
