...
{
    public class InstitutionalPPMPBDL : Controller
    {
        ...
        {
            return db.PPMPDeadlines.Select(d => d.FiscalYear).ToList();
        }
        ...
        public List<HRISDepartmentDetailsVM> GetDepartments(string UserEmail)
        {
            ...
            var projectCodes = db.ProjectDetails.Where(d =>
                                                       (d.ProjectItemStatus == ProjectDetailsStatus.ForEvaluation || d.ProjectItemStatus == ProjectDetailsStatus.ItemRevised || d.ProjectItemStatus == ProjectDetailsStatus.ForEvaluation))
