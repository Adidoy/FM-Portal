...
//        {
//            return FMISdb.PPMPDeadlines.Where(d => d.PurgeFlag == false).ToList();
//        }

//        //================================================================================================================

//        public List<EndUserProjectHeader> GetActiveProjects()
//        {
...
//        public List<EndUserProjectHeader> GetPurgedProject()
//        {
//            return FMISdb.EndUserProjects.Where(d => d.PurgeFlag == true).ToList();
//        }

//        public EndUserProjectHeader GetProjectDetails(int? ProjectID)
//        {
...
//        public EndUserProjectHeader AddEndUserProjectRecord()
//        {
//            EndUserProjectHeader _project = new EndUserProjectHeader();
...
//        public bool AddEndUserProjectRecord(EndUserProjectHeader Project)
//        {
//            EndUserProjectHeader _project = FMISdb.EndUserProjects.Find(Project.ID);
...
//        public bool UpdateProjectRecord(EndUserProjectHeader Project, bool DeleteFlag)
//        {
//            EndUserProjectHeader _project = FMISdb.EndUserProjects.Find(Project.ID);
//            DbPropertyValues _currentValues;
